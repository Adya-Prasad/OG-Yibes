  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        console.warn("[LoginForm] failed", res.status);
        return;
      }
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full rounded-2xl border border-indigo-400/45 bg-indigo-500/15 py-3 text-sm font-bold text-indigo-100 disabled:opacity-60"
      >
